const legalQ = [
  ...
  },
  {
    ...
    answer: 'In accordance with the French law "Informatique et Libertés", TFORE is committed to respecting the regulatory and ethical provisions on the protection of personal data. The information you provide when you register is stored on the platform in a secure and encrypted manner. Under no circumstances will TFORE sell your personal information to third parties.'
  },
  {
    question: "Are transactions on the platform secure?",

    answer: "TFORE uses the most advanced technical means to ensure the confidentiality and security of transactions on the platform. To manage your payment requests, TFORE uses the VeChain blockchain to create smart contracts and manage the secondary market."
  }
]
